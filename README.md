...
- 📚 I'm currently working on a personal project using SQL and Python to create a [mixed media recommendation app](https://github.com/zsurles/mixed-media-recommender) 🎥
...
- 💻 Tools and Skills: Python, R, SQL, Unix, Linux, Git, Jupyter Notebook, Pandas, Seaborn, Astropy, Scikit-learn, Matplotlib, Scipy, Numpy, Statsmodels, LaTeX, Adobe Illustrator, Miscrosoft suite and more! 
- 🌟 My dream job is to be a data scientist working in the gaming/entertainment industry or space industry!
